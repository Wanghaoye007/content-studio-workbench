...
- Floating panels and node cards: 24px to 28px.
...
- Node picker: 460px wide, two-column action grid, 72px minimum action height.
...
- Parameter panels remain floating, not docked, so the canvas stays central.
